<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerSplBookings.aspx.cs" Inherits="SouthernTravelsWeb.CustomerSplBookings" %>
         ...
         <!-- booked tickets -->
          <div class="tab-pane  fade in active" id="tab_bookedtkts"> 
            ...
            <div class="bookedtkts">
                ...
                <li><a href="#"  class="active">Special Tour Tickets</a></li>
                <li><a href="CustomerGroupBookings.aspx??MM=2">Group Tickets</a></li>
                </ul>
                
                <div class="tablewrap">
                	<h3 class="title">My <span>Special Tour Tickets</span><div class="welcometxt">Welcome, <span>  <% =Session["LoggedInUserName"]%></span></div></h3>
                	...
                	<asp:ImageButton ID="cmdPrev1" runat="server" ImageUrl="Assets/images/paging-inactive-left.jpg" OnClick="cmdPrev1_Click"  style="vertical-align:middle">
                	 ...
                	 <div class="tablewrap">
                                        <asp:DataGrid ID="dgDuplicateTickets" runat="server" Width="100%"
                                          ...
                                          <HeaderStyle CssClass="th" />
                                            ...
                                            <Columns>
                                                <asp:TemplateColumn HeaderText="Ticket No">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HiddenField ID="hdPnr" runat="server" Value='<%#DataBinder.Eval(Container.DataItem,"orderid") %>'/>
                                                        <a href="Customerspltour_tickets.aspx?id=<%#DataBinder.Eval(Container.DataItem,"rowid") %>&Ticket=kps">
                                                ...
                                                <asp:TemplateColumn HeaderText="Cancel Ticket" HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="center"
                                                    ...
                                                    <ItemTemplate>
                                                        <%--<asp:ImageButton ID="Button2" CommandName="btncancel" runat="server" ImageUrl="images/cancel.png" />--%>
