<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="International-GroupDeparture.aspx.cs" Inherits="SouthernTravelsWeb.International_GroupDeparture" %>
...
<body>
    ...
    <!-- end top note -->
    <header class="posrel innerheader" style="background-image: url(Assets/images/banner-fixed-intl.jpg)">
  <div class="herobanner">
     <UCHeader:UCHeaderEndUser ID="UCHeader" runat="server" fldMainSection="HOLIDAY_PACKAGE_INTERNATIONAL_FIXED" />
  </div>
</header>
