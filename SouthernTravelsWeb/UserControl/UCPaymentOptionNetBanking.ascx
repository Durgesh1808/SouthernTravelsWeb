<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCPaymentOptionNetBanking.ascx.cs" Inherits="SouthernTravelsWeb.UserControl.UCPaymentOptionNetBanking" %>

<div class="hPP" style="padding-top: 0px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <td height="30">
                ...
                <td>
                    ...
                    <td>
                    <div align="left" style="vertical-align: middle">
                        <img src="Assets/images/Kotak_Logo.gif" alt="Vijaya bank" border="0" style="vertical-align: middle"
                            height="24" width="70" loading="lazy"/>
            ...
            <tr>
                ...
                <td height="30">
                    <div align="left" style="vertical-align: middle">
                        <img src="Assets/images/PayZApp.png" alt="" border="0" style="vertical-align: middle" loading="lazy"/>Pay Zapp</div>
                </td>
                <td height="30">
                    <div align="left" style="vertical-align: middle">
                        <img src="Assets/images/PayZApp.png" alt="" border="0" style="vertical-align: middle" loading="lazy"/>Pay Zapp Debit</div>
                </td>
            </tr>
            <tr>
             <td>
                    <div align="left" style="vertical-align: middle">
                        <img src="Assets/images/RuPay.png" alt="RuPay" border="0" style="vertical-align: middle"
                            height="24" width="70" loading="lazy"/>
                        RuPay
                    </div>
                </td>
            ...
            <td>
                    <div align="left" style="vertical-align: middle">
                        <img src="Assets/images/State Bank of Bikaner.jpg" alt="State Bank Of Bikaner and Jaipur"
                            border="0" style="vertical-align: middle" width="70" height="24" loading="lazy"/>
                        State Bank Of Bikaner and Jaipur</div>
                </td>
                <td>
                    <div align="left" style="vertical-align: middle">
                        <img src="Assets/images/State Bank of patiala.jpg" alt="State Bank of Patiala" border="0"
                            style="vertical-align: middle" width="70" height="24" loading="lazy"/>
                        State Bank of Patiala</div>
                </td>
                <td>
                    <div align="left" style="vertical-align: middle">
