          ...
          <div class="" id="tab_hotelinfo">
           <div class="container">
            <div class="row rowgap">
              <div class="col-md-3">
					<img loading="lazy" src="Assets/images/hotel-zone/logo.jpg" class="img-responsive" alt="logo"/>           
              </div>
              <div class="col-md-9">
          ...
          <div class="tab-pane fade in active" id="tab_delux">
                ...
                <div class="row rowgap">
                	<div class="col-md-8">
                        ...
                        <div class="item"><img loading="lazy" src="Assets/images/hotel-zone/zone-room1.jpg" class="img-responsive" alt="room1"/></div>
...
<li>Fully loaded mini bar</li>
          ...
          <div class="tab-pane" id="tab_superdelux">
          	   <div class="row rowgap">
                	<div class="col-md-8">
                    	<div class="hotel_slider owl-carousel">
                        <div class="item"><img loading="lazy" src="Assets/images/hotel-zone/zone-trio1.jpg" class="img-responsive" alt="trio1"/></div>
                        <!-- <div class="item"><img loading="lazy" src="Assets/images/hotel-zone/zon-room1.jpg" class="img-responsive"></div> -->
...
<li>Fully loaded mini bar</li>
          ...
          <div class="tab-pane" id="tab_executive">
                 ...
                 <div class="row rowgap">
                	<div class="col-md-8">
                    	<div class="hotel_slider owl-carousel">
                        <div class="item"><img loading="lazy" src="Assets/images/hotel-zone/zone-quad1.jpg" class="img-responsive" alt="quad1"/></div>
                        <!-- <div class="item"><img loading="lazy" src="Assets/images/hotel-zone/zon-room1.jpg" class="img-responsive"></div> -->
...
<li>Fully loaded mini bar</li>
          ...
          <div class="tab-pane" id="tab_royalst">
                   ...
                   <div class="row rowgap">
                	<div class="col-md-8">
                    	<div class="hotel_slider owl-carousel">
                        <div class="item"><img loading="lazy" src="Assets/images/hotel-zone/zone-suite1.jpg" class="img-responsive" alt="suite1"/></div>
                        <!-- <div class="item"><img loading="lazy" src="Assets/images/hotel-zone/zon-room1.jpg" class="img-responsive"></div> -->
...
<li>Fully loaded mini bar</li>
           ...
           <section id="hotel_tab3">
               ...
               <div class="row rowgap">
               <div class="col-md-4">
                <img loading="lazy" src="Assets/images/hotel-zone/restaurant.jpg" class="img-responsive" alt="restaurant"/>
               </div> 
               <div class="col-md-8">
...
<li class="col-md-6 paddingleft0">Dinner : 7:30 pm to 11:30 pm</li>
                 ...
                 <div class="row">
               <div class="col-md-4">
               <img loading="lazy" src="Assets/images/hotel-zone/Zone-Playa.jpg" class="img-responsive" alt="Playa"/>
               </div> 
               <div class="col-md-8">
        		...
        		<%--<h2 class="title showonmobile">Facilities & Amenities</h2>--%>
                 <div class="container restaurants">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-4">
                     	 <div class="hotel_slider owl-carousel">
                        <div class="item"> <img loading="lazy" src="Assets/images/hotel-zone/Zone-Swimming-Pool.jpg" class="img-responsive" alt="Swimming"/></div>
                        <div class="item"> <img loading="lazy" src="Assets/images/hotel-zone/Zone-Gym.jpg" class="img-responsive" alt="Gym"/></div>
                        <div class="item"> <img loading="lazy" src="Assets/images/hotel-zone/Zone-Spa.jpg" class="img-responsive" alt="Spa"/></div>
                        </div>
                     </div>
          ...
          <!--end tab_facilities --> 
            ...
            <h2 class="title showonmobile">Conference Room</h2>
              <div class="container">
                <div class="row">
                  <div class="col-md-3">
                  <img loading="lazy" src="Assets/images/hotel-zone/Conference-Hall.jpg" class="img-responsive" alt="Conference-Hall"/>
                  </div>
                   <div class="col-md-3">
                  <img loading="lazy" src="Assets/images/hotel-zone/conference-room.jpg" class="img-responsive" alt="Conference-room"/>
                  </div>
