...
//                try
//                {
//                    //string lstrJDate = DataLib.scriptclear(Request.QueryString["jdate"].ToString());
//                    string lstrJDate = DataLib.scriptclear(Request.QueryString["jdate"].ToString().Replace("-", "/"));
//                    ddlJdate.Value = DataLib.scriptclear(Request.QueryString["jdate"].ToString().Replace("-", "/"));
//                    ddlJdate1.Value = DataLib.scriptclear(Request.QueryString["jdate"].ToString().Replace("-", "/"));
...
//        {
//            strCn = DataLib.getConnectionString(); ;
...
//                ViewState["ptourid"] = ClsCommon.ConvertStringint(Request.QueryString["TourID"]);
...
//                try
//                {
//                    ModifyMetaTag(ClsCommon.ConvertStringint(Request.QueryString["TourID"]));
//                    BindTourItenerary(ClsCommon.ConvertStringint(Request.QueryString["TourID"]));
...
//                    {
//                        if (Request.QueryString["jdate"] != null && Request.QueryString["jdate"] != "")
//                        {
//                            discount.Value = validateDiscount(fldQStrJDate);

//                            string acnonac = DataLib.getvacantseats(ClsCommon.ConvertStringint(DataLib.
//                                funClear(Request.QueryString["Tourid"])), Convert.ToString(
//                                Request.QueryString["jdate"]).Replace("-", "/"));
...
//                                #endregion
//                                string str = pClsObj.fnGetCombinationTour(ClsCommon.ConvertStringint(Request.QueryString["Tourid"]));
//                                if (str == "0")
//                                {
//                                    // For Single Tour
//                                    fillddlJdate(ClsCommon.ConvertStringint(DataLib.funClear(
//                                         Request.QueryString["Tourid"])), 0);
//                                    //Geting a Dispatur Time
//                                    Dispup(ClsCommon.ConvertStringint(DataLib.funClear(
//                                         Request.QueryString["Tourid"])), "N");
//                                    hidTourId.Value = DataLib.funClear(Request.QueryString["Tourid"]);
//                                    combination.Value = "N";
//                                }
//                                else
//                                {
...
//                            {
//                                fillddlJdate(ClsCommon.ConvertStringint(DataLib.funClear(Request.QueryString["Tourid"])), 0);
//                                Dispup(ClsCommon.ConvertStringint(DataLib.funClear(Request.QueryString["Tourid"])), "N");
//                                hidTourId.Value = DataLib.funClear(Request.QueryString["Tourid"]);
//                            }
//                            else
//                            {
...
//                        {
//                            table5.Visible = true;
//                            int tourid = ClsCommon.ConvertStringint(DataLib.funClear(Request.QueryString["tourid"]));
...
//            Tourno = ClsCommon.ConvertStringint(DataLib.funClear(Request.QueryString["Tourid"]));
...
//                                Request.QueryString["Tourid"] + "_" + Request.QueryString["jdate"];
...
//                Convert.ToInt32(DataLib.funClear(Request.QueryString["Tourid"])), fldDDLJDate);
//            string[] ss = avail.Split('-');
//            if (ss.Length > 1)
//            {
//                availaseat = ClsCommon.ConvertStringint(ss[0]);
...
//                            Session["Panel2Step"] = "Panel2Step";
//                            hlmsgerr.NavigateUrl = "Booking-" + Convert.ToString(hdfTourName.Value) + "_" + RemoveSlashAmp(strEncrypt) + "_" +
//                                Request.QueryString["Tourid"] + "_" + RemoveSlashAmp(Request.QueryString["jdate"]); ;
//                        }
//                        else
//                        {
//                            strEncrypt = DataLib.TripleDESEncode(lblTourName.Text, endecript);
...
//                        AssignOrderID();
//                        if (!(Request.QueryString["Rowid"] == null))
//                            updatebook(Convert.ToInt32(DataLib.funClear(Request.QueryString["Tourid"])),
//                                seatnumbers.Length, fldDDLJDate, OrderIDH.Value, ClsCommon.ConvertStringint(DataLib.funClear(
//                                Request.QueryString["Rowid"])), sno);
//                        else
//                            insertbook(Convert.ToInt32(DataLib.funClear(Request.QueryString["Tourid"])),
...
//                if (!(Request.QueryString["Rowid"] == null))
//                {
//                    updatebook(ClsCommon.ConvertStringint(DataLib.funClear(Request.QueryString["Tourid"])),
...
//                else
//                {
//                    insertbook(ClsCommon.ConvertStringint(Request.QueryString["Tourid"]), seatnumbers.Length,
...
//                // Server.Transfer("TourBooking.aspx?orderid=" + ViewState["strDeCrypt"].ToString() + "&TourId=" + ddlTour.SelectedValue + "&A=" + ViewState["TotalPaxAdults"] + "&C=" + ViewState["TotalPaxChilds"] + "");
//                Session["Panel2Step"] = null;
...
//                                string url = "";
//                                clsEndUserDBML clsObj = null;
//                                int? lStatus = 0;
//                                try
//                                {

//                                    clsObj = new clsEndUserDBML();
...
//            if ((Request.QueryString["ltc"] == null) && (Request.QueryString["ltc"] != "0"))
//            {
//                Response.Redirect("TourBooking.aspx?orderid=" + strEncrypt + "&TourID=" + Request.QueryString["Tourid"]);
//            }
//            else
//            {
//                Response.Redirect("TourBooking.aspx?orderid=" + strEncrypt + "&TourID=" + Request.QueryString["Tourid"]);
...
//            clsEndUserDBML objOther = new clsEndUserDBML();
...
//            DataSet lds = null;
//            clsLinqtoDB clsObj = null;
//            try
//            {
//                clsObj = new clsLinqtoDB();
...
//                    Response.Redirect("TourBooking.aspx?orderid=" + RemoveSlashAmp(strEncrypt) + "&TourID=" + Request.QueryString["Tourid"] + "&jdate=" +
//                         Request.QueryString["jdate"].ToString().Split(' ')[0].ToString());
...
//                using (SqlCommand cmd = new SqlCommand("SP_AddOperatingBranchForEBK_SPL", lConn))
//                {
...
//        {
//            //Boolean tt = ClsCommon.Block_Seats(tstr, tserial);
...
//                pClsObj = new clsLinqtoDB();
//                validateDiscount = pClsObj.fnValidateDiscount(pJDate, ClsCommon.ConvertStringint(Request.QueryString["Tourid"]));
...
//                //DateTime? pJDate = Convert.ToDateTime(jdate);
//                pClsObj = new clsLinqtoDB();
//                ChkBusType = pClsObj.fnChkBusType(pJDate, ClsCommon.ConvertStringint(Request.QueryString["Tourid"]));
//                return ChkBusType;
//            }
//            finally
//            {
...
//            STSPLOrOther objOther = new STSPLOrOther();

//            try
//            {
//                lGetPlaceName = new List<GetTourPlaceInfo_SPResult>();

//                lGetPlaceName = objOther.fnGetTourPlaceInfo(ClsCommon.ConvertStringint(Request.QueryString["TourID"]), 1).ToList();
...
//                lGetResult = objOther.fnGetTourItenerary(ClsCommon.ConvertStringint(Request.QueryString["TourID"]), 1).ToList();
//                if (lGetResult != null && lGetResult.Count > 0)
//                {
//                    ltrNotes.Text = lGetResult[0].Notes.ToString().Replace("<p>", "").Replace("</p>", "").Replace("color: #ffffff", "color: #000000");

//                    if (lGetResult[0].OccasionalItinerary != null)
//                    {
//                    }
//                }
//            }
...
//            clsEndUserDBML pClsObj = null;
//            List<GetFbDetail_spResult> lResult = null;
//            try
//            {
//                pClsObj = new clsEndUserDBML();
//                ViewState["rowid"] = "";
//                string FaceBookID = "";
...
//            ClsCommon clsHCobj = new ClsCommon();
...
//        {
//            string Ids = System.Configuration.ConfigurationManager.AppSettings["IntlEBKTourIDs"];
...
//                lCommand = new SqlCommand(StoredProcedures.SP_Update_EBK_TCSVAL, lConn);

//                lCommand.CommandType = CommandType.StoredProcedure;
//                lCommand.CommandTimeout = 20 * 1000; // 20 seconds

//                // Parameters
//                lCommand.Parameters.Add("@OrderID", SqlDbType.VarChar).Value = pRowID;
//                lCommand.Parameters.Add("@Tourid", SqlDbType.VarChar).Value = pTourNo;
//                lCommand.Parameters.Add("@TCSVal", SqlDbType.VarChar).Value = pTCSVal;
//                lCommand.Parameters.Add("@IsTCSsubmit", SqlDbType.Bit).Value = ChkFilledTCS.Checked ? 1 : 0;
//                lCommand.Parameters.Add("@Action", SqlDbType.VarChar).Value = pAction;
