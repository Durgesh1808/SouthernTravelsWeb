              ...
              <div class="" id="tab_hotelinfo">
                <div class="container">
                  <div class="row rowgap">
                    <div class="col-md-3"> <img src="Assets/images/hotel-st-grand.jpg" class="img-responsive"> </div>
                    <div class="col-md-9">
                      ...
                      <div class="tab-content tab-content-inner"> 
                          ...
                          <div class="row rowgap">
                            <div class="col-md-8">
                              <div class="hotel_slider owl-carousel">
                                <div class="item"><img src="Assets/images/hotel-st-grand/deluxe1.jpg" class="img-responsive"></div>
                        ...
                        <div class="tab-pane" id="tab_executive">
                          <div class="row rowgap">
                            <div class="col-md-8">
                              <div class="hotel_slider owl-carousel">
                                <div class="item"><img src="Assets/images/hotel-st-grand/executive1.jpg" class="img-responsive"></div>
                                <div class="item"><img src="Assets/images/hotel-st-grand/executive2.jpg" class="img-responsive"></div>
                                <div class="item"><img src="Assets/images/hotel-st-grand/executive3.jpg" class="img-responsive"></div>
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="txtsection">
                        ...
                        <div class="tab-pane" id="tab_royalst">
                          <div class="row rowgap">
                            <div class="col-md-8">
                              <div class="hotel_slider owl-carousel">
                                <div class="item"><img src="Assets/images/hotel-st-grand/royal1.jpg" class="img-responsive"></div>
     ...
     <td> <i class="fa fa-rupee"></i> 400/-</td>
           ...
           <section id="hotel_tab3">
                ...
                <div class="container restaurants">
                	<div class="row">
                    <div class="col-md-5"><img src="Assets/images/restaurants-Vij.jpg" class="img-responsive"></div>
                    <div class="col-md-7">
...
<li>All Major Credit Cards accepted</li>
                   ...
                   <div class="col-md-5"> <%--<img src="images/aminities.jpg" class="img-responsive">--%></div>
            ...
            <h2 class="title showonmobile">Conference Room</h2>
              <div class="container">
                <div class="row">
                  <div class="col-md-3">
                   <img src="Assets/images/hotel-st-grand-conferenceroom.jpg" class="img-responsive">
