<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerBookedTickets.aspx.cs" Inherits="SouthernTravelsWeb.CustomerBookedTickets" %>
         ...
         <!-- booked tickets -->
          <div class="tab-pane  fade in active" id="tab_bookedtkts"> 
            ...
            <div class="bookedtkts">
                ...
                <ul class="breadcrumb">
                <li ><a href="#" class="active">Fixed Tour Tickets</a></li>
                <li><a href="CustomerSplBookings.aspx?MM=2" >Special Tour Tickets</a></li>
                <li><a href="CustomerGroupBookings.aspx?MM=2">Group Tickets</a></li>
                </ul>
                
                <div class="tablewrap">
                	<h3 class="title">My <span>Fixed Tour Tickets</span><div class="welcometxt">Welcome, <span>  <% =Session["LoggedInUserName"]%></span></div></h3>
                	...
                	<asp:Label ID="lblMsg" runat="server"></asp:Label>
                	 <div class="tablewrap">
                	<asp:DataGrid ID="dgDuplicateTickets" runat="server" 
                                            ...
                                            <Columns>
                                                <asp:TemplateColumn HeaderText="PNR Number">
                                                    ...
                                                    <ItemTemplate>
                                                        <a href="customerbooked_Tickets.aspx?orderid=<%#DataBinder.Eval(Container.DataItem,"orderid") %>&Ticket=kps">
                                                            <asp:Label ID="lblticketno" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"orderid") %>'></asp:Label></a>
                                                        <asp:HiddenField runat="server" ID="hidBranch" Value='<%# Eval("Branchcode") %>' />
                                                        <asp:HiddenField runat="server" ID="hidAgentID" Value='<%# Eval("Agentid") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:BoundColumn DataField="Ticketcode" HeaderText="Ticket No">
                                                ...
                                                <asp:TemplateColumn HeaderText="LTC/LFC" HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="center"
                                                    HeaderStyle-HorizontalAlign="center">
                                                    <ItemTemplate>
                                                        <asp:Button ID="Button1" CommandName="btnRequest" runat="server" CssClass="commonbtn" Text="Request"/>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="Cancel Ticket" HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="center"
                                                    HeaderStyle-HorizontalAlign="center">
                                                    <ItemTemplate>
                                                     <asp:Button ID="Button2" CommandName="btncancel" runat="server" CssClass="commonbtn" Text="Cancel" />
                                                   </ItemTemplate>
                                                </asp:TemplateColumn>
                                            </Columns>
